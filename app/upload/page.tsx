...
export default function Upload()  {
    ...
    let[fileDisplay,setFileDispaly] =useState<string>('');
    ...
    return(
        <>
            <UploadLayout>
                <div className="w-full mb-[40px] bg-white shadow-lg rounded-md py-6 mb:px-10 px-4">
                    <div>
                    ...
                    <div className="mt-8 md:flex gap-6">
                        {! fileDisplay ? (
                            ...
                            >
                                ...
                                <p className="mt-1.5 text-gray-500 text-[13px]">Or drge and drop a file</p>
                            ...
                            className="
                                ...
                                >
                                    ...
                                    <div className="absolute -bottom-12 flex items-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
                                        ...
                                        <button onClick={() =>clearVideo()} className="text-[11px] ml-2 font-aemibold">
                                            Change
                                        </button>
                                    </div>                           
                                </div>
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-[#F8F8F8] py-4 px-6">
                                ...
                                <div className="flex justify-center max-w-[130px] w-full h-full text-center my-auto">
