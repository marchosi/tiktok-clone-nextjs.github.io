        ...
        <>
            <div id="TopNav" className="fixed bg-white z-30 flex items-center w-full border-b h-[60px]">
                <div className={`flex items-center justify-between gap-6 w-full px-4 mx-auto ${pathname === '/' ? 'max-w-[1150px] ': ''}`}>
                    ...
                    <div  className={`relative mb:flex items-center justify-end bg-[#F1F1F2] p-1 rounded-full max-w-[430px]`}
                    onClick={() => SearchInput()}>
                    {/* ${shouldShowInput ? "" : "hidden"} */}
                        <input 
                            type="text"
                        ...
                        <div className="flex items-center">
                            <div className="reacative">
                                ...
                                <div className="absolute  bg-white roundeed-lg py-1.5 w-[200px] shadow-xl border top-[40px] right-0">
                                    <button 
                                    className="flex items-center w-full justify-start py-3 px-2 hover:bg-gray-100 cusor-pointer"
                                    >
                                        <BiUser size="20"/>
